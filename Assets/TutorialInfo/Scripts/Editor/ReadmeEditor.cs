...
namespace TutorialInfo.Scripts.Editor
{
    ...
    {
        private static string _sShowedReadmeSessionStateName = "ReadmeEditor.showedReadme";

        private static string _sReadmeSourceDirectory = "Assets/TutorialInfo";
        ...
        [FormerlySerializedAs("_mLinkStyle")] [FormerlySerializedAs("m_LinkStyle")] [SerializeField]
        ...
        [FormerlySerializedAs("_mTitleStyle")] [FormerlySerializedAs("m_TitleStyle")] [SerializeField]
        ...
        [FormerlySerializedAs("_mHeadingStyle")] [FormerlySerializedAs("m_HeadingStyle")] [SerializeField]
        ...
        [FormerlySerializedAs("_mBodyStyle")] [FormerlySerializedAs("m_BodyStyle")] [SerializeField]
        ...
        [FormerlySerializedAs("_mButtonStyle")] [FormerlySerializedAs("m_ButtonStyle")] [SerializeField]
